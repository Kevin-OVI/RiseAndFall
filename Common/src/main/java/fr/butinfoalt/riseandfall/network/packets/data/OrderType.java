...
public enum OrderType {
    CREATE_BUILDING(OrderCreateBuilding.class, readHelper -> new OrderCreateBuilding(Identifiable.getById(ServerData.getInstance().buildingTypes(), readHelper.readInt()), readHelper.readInt())),
    CREATE_UNIT(OrderCreateUnit.class, readHelper -> new OrderCreateUnit(Identifiable.getById(ServerData.getInstance().unitTypes(), readHelper.readInt()), readHelper.readInt()));
