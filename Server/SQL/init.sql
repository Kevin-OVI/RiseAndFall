...
CREATE TABLE player (
    ...
    exited_game BOOLEAN NOT NULL DEFAULT false,
...
VALUES
    ...
    ('Mine', 'Structure permettant d''extraire de l''or pour financer l''économie du royaume mais nécessite de l''intelligence pour être débloquée', 25, 15, 25, 0, 120, 0, 0, NULL, false),
    ...
    ('Nécropole','Ancienne ville de mage remplie de rituels sinistres',120 ,35 ,15 ,20 ,150 ,10 ,0 ,1, false),
    ...
    ('Marché d''Esclaves', 'Endroit où les orcs achètent et vendent des esclaves', 150, 35, 50, 10, 100, 15, 0, 3, false),

    ('Tour de Mage', 'Endroit où les prochains mages sont formés', 20, 20, 1, 2, 170, 10, 0, 4, false),
    ('Arbre de Vie', 'Endroit où les elfes s''instruisent', 180, 50, 50,20 , 200, 5, 0, 4, false),
...
VALUES
    ('Guerrier', 'Une unité de combat faible mais polyvalente', 8.0, 0, 10.0, 20.0, NULL),
    ...
    ('Nécromancien','Un ancien héro humain ressuscité et invoquant la mort derrière lui', 250, 100, 100.0, 210.0, 1),

    ('Uruk Noir', 'Créature imposante et très puissante mais débile', 80, 6, 80.0, 30.0, 3),
    ('Chef des Orcs','Créature extrêmement puissante', 200, 100, 200.0, 170.0, 3),
    ...
    ('Nain Ultime','Les meilleurs parmi les meilleurs des Rois Mineurs', 250, 100, 170.0, 150.0, 5),
